  ...
  <div class="container-fluid">
    <div class="animated fadeIn">
      <div class="card">
        ...
        <div class="kotak">
          <b-button variant="success"><router-link to="/kab/add">Add Data</router-link></b-button>
        </div>
...
import axios from 'axios';
  ...
  export default {
    ...
    methods: {
      deleteItem(row) {
        let app = this
        axios.delete(apiUrl() + '/kab/' + this.deleteID + '?token=' + app.$session.get('token'), {
      ...
      editItem(row) {
        this.$router.push({ name: 'editkab', params: { id: row.id} })
      },
      getdata () {
        let app = this
