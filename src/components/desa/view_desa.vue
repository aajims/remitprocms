  ...
  <div class="container-fluid">
    <div class="animated fadeIn">
      <div class="card">
        ...
        <div class="kotak">
          <b-button variant="success"><router-link to="/desa/add">Add Data</router-link></b-button>
        </div>
...
import axios from 'axios';
  ...
  export default {
    ...
    methods: {
      deleteItem(row) {
        let app = this
        axios.delete(apiUrl() + '/desa' + this.deleteID + '?token=' + app.$session.get('token'), {
      ...
      editItem(row) {
        this.$router.push({ name: 'editdesa', params: { id: row.id} })
      },
      getdata () {
        let app = this
