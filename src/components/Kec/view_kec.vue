  ...
  <div class="container-fluid">
    <div class="animated fadeIn">
      <div class="card">
        ...
        <div class="kotak">
          <b-button variant="success"><router-link to="/kec/add">Add Data</router-link></b-button>
        </div>
...
import axios from 'axios';
  ...
  export default {
    ...
    methods: {
      deleteItem(row) {
        let app = this
        axios.delete(apiUrl() + '/kec' + this.deleteID + '?token=' + app.$session.get('token'), {
      ...
      editItem(row) {
        this.$router.push({ name: 'editkec', params: { id: row.id_kec} })
      },
      getdata () {
        let app = this
